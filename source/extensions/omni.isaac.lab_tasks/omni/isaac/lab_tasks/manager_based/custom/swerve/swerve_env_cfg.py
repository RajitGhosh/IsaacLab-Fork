...
@configclass
class SwerveSceneCfg(InteractiveSceneCfg):
    """Configuration for a Swerve scene."""
    ...
    # swerve
    robot: ArticulationCfg = SWERVE_CFG.replace(prim_path="{ENV_REGEX_NS}/Robot")
...
@configclass
class SwerveEnvCfg(ManagerBasedRLEnvCfg):
    """Configuration for the locomotion velocity-tracking environment."""

    # Scene settings
    scene: SwerveSceneCfg = SwerveSceneCfg(num_envs=4096, env_spacing=5.0)
    # Basic settings
